...
export default class SchedulerClient extends JanusClient {
  ...
  public createCatalogSyncSchedule = (
    ...
    return this.http.post(
      ...
      schedulerData,
      { metric: 'category-tree-update-synchronizer-create-schedule' }
    )
  }

  public viewCatalogSyncSchedule = async (id: string): Promise<ViewSchedulerResponse> => {
    return this.http.get(routes.getSchedule(this.context.workspace, this.context.account, id), {
      metric: 'category-tree-update-synchronizer-view-schedule',
    })
  }

  public deleteCatalogSyncSchedule = async (id: string) => {
    return this.http.delete(routes.getSchedule(this.context.workspace, this.context.account, id), {
      metric: 'category-tree-update-synchronizer-delete-schedule',
    })
  }
}
